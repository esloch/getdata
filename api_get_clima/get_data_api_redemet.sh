...
# param: $1 = estação "SBRJ" 
# param: $2 = mês "2020$201"
# param: $1 = dirname "SBRJ"/
# result: $1/metar_"$1"_2020_"$2".txt 
# execute $ bash busca_mensagens_api_redemet_linux.sh SBRJ 03
localidades_ou_sinoticos="$1"

arquivo_resultado="$1"/metar_"$1"_2020_"$2".txt 

# Data do início da consulta. Formato YYYmmdd
data_inicio="2020$201"
